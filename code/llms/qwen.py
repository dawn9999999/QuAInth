...
""",
        ...
        "stage2": {
            "name": "block1_stage2",
            "template": """STRICTLY follow this format:
...
""",
        ...
        "stage3": {
            "name": "block1_stage3",
            "template": """Explain this function in the context of Bernstein-Vazirani.
STRICTLY follow this format:
1. Algorithm Role: [Detailed description in Bernstein-Vazirani]
...
""",
        ...
        "stage3": {
            "name": "block2_stage3",
            "template": """Explain this algorithm implementation in the context of Bernstein-Vazirani.
STRICTLY follow this format:
1. Algorithm Role: [Detailed description in Bernstein-Vazirani]
2. Quantum Formula/Gates Involved: [LaTeX representation of gate operations/formulas]
3. Algorithm Parameters: [List parameters with [name]=[mathematical meaning]]
...
""",
        ...
        "stage2": {
            ...
            "template": """STRICTLY follow this format:
1. Implementation: [Description of operations]
2. Variables: [List all variables with [name]=[role]]
...
""",
        ...
        "stage3": {
            "name": "block3_stage3",
            "template": """Analyze print logic:
STRICTLY follow this format:
1. Implementation: [Detailed description of operations]
2. Variables: [List all variables with [name]=[role]]
...
def detect_block_type(signature: str) -> str:
    ...
    if "create_oracle" in signature.lower():
        return "block1"
    elif "berstein" in signature.lower():
        return "block2"
    elif "kernel_draw" in signature.lower():
        return "block3"
    return "unknown"
...
if __name__ == "__main__":
    input_file = "C:/Users/PC/Desktop/qrs/code/lv1/code_blocks.txt"  # Input file with code snippets
    output_file = "C:/Users/PC/Desktop/qrs/code/lv1/generated_comments.txt"  # Output file for results
